...
namespace TextEdit.Visual
{
	public interface IVisualGroup : IList<IVisual>
	{
		...
		/// <summary>
		/// Retrieves the index of visual at the given y position
		/// </summary>
		...
		/// <summary>
		/// Retrieves the height of a range of visual elements within the group.
		/// </summary>
		/// <param name="start">The starting index of the range.</param>
		/// <param name="count">The number of visual elements in the range.</param>
		/// <returns>The total height of the specified range of visual elements.</returns>
		public double GetHeight(int start, int count);

		/// <summary>
		/// Retrieves the maximum width of a range of visual elements within the group.
		/// </summary>
		/// <param name="start">The starting index of the range.</param>
		/// <param name="count">The number of visual elements in the range.</param>
		/// <returns>The maximum width of the specified range of visual elements.</returns>
		public double GetWidth(int start, int count);

		/// <summary>
		/// Retrieves the bounding size of a range of visual elements within the group.
		/// </summary>
		/// <param name="start">The starting index of the range.</param>
		/// <param name="count">The number of visual elements in the range.</param>
		/// <returns>The bounding size that encloses the specified range of visual elements.</returns>
